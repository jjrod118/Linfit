...
import collections
from _future_ import (unicode_literals, absolute_import, print_function, division)
import time
...
class PiVideoStream2:
	...
	self.streamIO = io.BytesIO()
        self.stream = self.camera.capture_continuous(self.streamIO, format="jpeg", bayer=True,  use_video_port=True)
        self.frame = None
        self.stopped = False
